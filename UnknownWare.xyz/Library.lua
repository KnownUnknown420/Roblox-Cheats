...
menu.outline.outline.main.text.Text = "UnknownWare.xyz"
...
function library:saveConfig()
    ...
    writefile("UnknownWare/Configs/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
...
function library:loadConfig()
    ...
    if not isfile("UnknownWare/Configs/"..name..".cfg") then
        library:notify("Config file not found!")
        return
    end
    local config = game:GetService("HttpService"):JSONDecode(readfile("UnknownWare/Configs/"..name..".cfg"))
...
function library:refreshConfigs()
    local tbl = {}
    for i,v in next, listfiles("UnknownWare/Configs") do
...
function library:deleteConfig()
    if isfile("UnknownWare/Configs/"..library.flags["selected_config"]..".cfg") then
        delfile("UnknownWare/Configs/"..library.flags["selected_config"]..".cfg")
        library:refreshConfigs()
    end
end
